...
public class Compare {
	...
	private void com(){
		...
		for(String s:key){
			...
			if((!(temp.containsKey(s)&&temp.get(s).equals(cinfo.get(s))))&&(!((s.substring(s.length()-19).equals("mods/GeeksCraft.jar"))||(s.substring(s.length()-57).equals("mods/carpentersblocks/CarpentersBlocksCachedResources.zip"))))){
